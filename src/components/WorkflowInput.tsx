      ...
      <div className="flex flex-col space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label htmlFor="preset-select" className="text-xs font-bold text-zinc-400 uppercase tracking-wider flex items-center space-x-1.5">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <label htmlFor="story-input" className="text-xs font-bold text-zinc-400 uppercase tracking-wider">
              Product Specification / User Story
            </label>
            <span className="text-3xs font-mono text-zinc-500 bg-zinc-900 border border-zinc-800/80 px-2 py-0.5 rounded">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
          <div className="flex items-center space-x-2 text-3xs text-zinc-500 leading-normal">
          ...
          <div className="flex items-center space-x-2 justify-end">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 rounded-xl bg-gradient-to-r from-indigo-600 to-cyan-500 hover:from-indigo-550 hover:to-cyan-450 px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-indigo-500/10 hover:shadow-indigo-500/20 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
